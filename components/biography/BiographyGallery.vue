...
<template>
  <BaseGallery class="gallery">
    <BaseCard has-shadow v-for="(line, idx) in PRINCIPLES" :key="idx" class="gallery__card">
      <BaseSubtitle class="gallery__title">{{ line.title }}</BaseSubtitle>
      <BaseText class="gallery__text">{{ line.text }}</BaseText>
    </BaseCard>
  </BaseGallery>
</template>
